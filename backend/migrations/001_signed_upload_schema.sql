...
CREATE TABLE IF NOT EXISTS revisions (
    ...
    -- File metadata
    storage_path TEXT NOT NULL, -- e.g., projects/{projectId}/models/{modelId}/revisions/{revisionId}/model.ifc
    file_name TEXT NOT NULL,
    file_size BIGINT,
    sha256 TEXT, -- Optional hash for duplicate detection
    
    -- Revit metadata (optional)
    revit_doc_guid TEXT,
    revit_view_id TEXT,
    element_ids JSONB, -- Array of Revit element IDs or IFC GUIDs
...
CREATE TABLE IF NOT EXISTS shares (
    ...
    qr_storage_path TEXT, -- e.g., shares/{shareId}.png
